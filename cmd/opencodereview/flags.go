...
Examples:
  ...
  # Codex ChatGPT auth + Responses API
  ...
  ocr config set llm.protocol responses
...
Provider fields: api_key, url, protocol, model, models, auth_header, auth_mode, auth_file, extra_body`)
}
